...
android {
    ...
    project.setProperty("archivesBaseName", "RootlessBrennanDSP-v${AndroidConfig.versionName}")
    ...
    defaultConfig {
        ...
        manifestPlaceholders["label"] = "RootlessBrennanDSP"
    ...
    productFlavors {
        ...
        create("root") {
            ...
            manifestPlaceholders["label"] = "BrennanDSP"
            project.setProperty("archivesBaseName", "BrennanDSP-v${AndroidConfig.versionName}-${AndroidConfig.versionCode}")
